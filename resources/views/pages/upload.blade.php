    ...
    <div class="row">
        <div class="col-md-offset-1 col-md-10">
            ...
            <div class="jumbotron how-to-create" >
                ...
                <h4 style="text-align: center;color:#428bca;">Upuść obrazy w tym obszarze <span class="glyphicon glyphicon-hand-down"></span></h4>
            ...
            <div class="jumbotron how-to-create">
                <ul>
                    <li>Zdjęcie zostanie automatycznie zapisane</li>
                    <li>Maksymalny rozmiar pliku to 8MB</li>
                </ul>
